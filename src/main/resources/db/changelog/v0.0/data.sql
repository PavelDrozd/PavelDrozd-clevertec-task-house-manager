...
VALUES ('79e17dfd-a27d-45b6-8c72-a15538b8216e', 'Лазарева', 'Мария', (SELECT id FROM sex WHERE name = 'FEMALE'), 'MP', '7332632', '2018-08-29T06:12:15.156', '2024-01-03T09:12:15.156', (SELECT id FROM houses WHERE uuid = 'ac602dde-9556-4ef5-954c-aeebc42c5056')),
		...
		('789c8c63-a58d-4e50-a4b4-33c15debfaf3', 'Андрей', 'Румянцев', (SELECT id FROM sex WHERE name = 'MALE'), 'MP', '9474383', '2023-09-29T06:05:15.156', '2023-09-29T06:05:15.156', (SELECT id FROM houses WHERE uuid = 'b99d623b-4b7e-4c89-afce-2bed07ceb9fc')),
		...
		('fd839347-a17c-44f0-a8b7-77b53d8a652d', 'Полина', 'Леонова', (SELECT id FROM sex WHERE name = 'FEMALE'), 'MC', '1593875', '2023-12-28T07:12:15.156', '2023-12-28T07:12:15.156', (SELECT id FROM houses WHERE uuid = '8ca3955d-b436-471d-872f-f2ce07ac3f15'));
